# ClipDrop 0.4.1 Local Validation
...
- Adobe UPIA listed `ClipDrop 0.4.1` as enabled for Premiere Pro.
...
- `ClipDrop-0.4.1-macOS-arm64.dmg` was built successfully.

## Installed Paths

```text
/Applications/ClipDrop.app
dist/ClipDrop-0.4.1.ccx
companion/dist/ClipDrop-0.4.1-macOS-arm64.dmg
```
...
1. The panel footer reads `v0.4.1`.
