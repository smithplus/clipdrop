# ClipDrop 0.4.0 Local Validation
...
- Adobe UPIA listed `ClipDrop 0.4.0` as enabled for Premiere Pro.
...
- `ClipDrop-0.4.0-macOS-arm64.dmg` was built successfully.

## Installed Paths

```text
/Applications/ClipDrop.app
dist/ClipDrop-0.4.0.ccx
companion/dist/ClipDrop-0.4.0-macOS-arm64.dmg
```
...
1. The panel footer reads `v0.4.0`.
